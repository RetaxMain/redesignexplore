...
const SchoolDetails: React.FC<SchoolDetailsProps> = ({
  ...
  // Fallback for feeStructure
  const fee = school.feeStructure || {
    class1to5: 0,
    class6to8: 0,
    class9to10: 0,
  ...
  const amenities = school.amenities || [];
            ...
            <div className="flex items-start justify-between">
              <div>
                <div className="flex items-center space-x-3 mb-4">
                  <span
                    className={`inline-flex items-center gap-2 px-3 py-1 rounded-lg text-sm font-medium border ${getTypeColor(
                      school.type
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    {(school.students / 1000).toFixed(1)}K
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                      ...
                      <span className="font-semibold text-gray-900">
                        {fee.class11to12Science === 0
                          ? "Free"
                          : `$${fee.class11to12Science.toLocaleString()}`}
                      </span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                      <span className="text-gray-700">Commerce Stream</span>
                      <span className="font-semibold text-gray-900">
                        {fee.class11to12Commerce === 0
                          ? "Free"
                          : `$${fee.class11to12Commerce.toLocaleString()}`}
                      </span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                      <span className="text-gray-700">Arts Stream</span>
                      <span className="font-semibold text-gray-900">
                        {fee.class11to12Arts === 0
                          ? "Free"
                          : `$${fee.class11to12Arts.toLocaleString()}`}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {admissionProcess.map((step, index) => (
                  <div
                    key={index}
                    className="flex items-center p-4 bg-orange-50 rounded-lg border border-orange-200"
                  >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                {achievements.map((achievement, index) => (
                  <div
                    key={index}
                    className="flex items-center p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-100"
                  >
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {fee.class1to5 === 0
                      ? "Free"
                      : `$${(fee.class1to5 / 1000).toFixed(0)}K`}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {fee.class6to8 === 0
                      ? "Free"
                      : `$${(fee.class6to8 / 1000).toFixed(0)}K`}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {fee.class9to10 === 0
                      ? "Free"
                      : `$${(fee.class9to10 / 1000).toFixed(0)}K`}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {fee.class11to12Science === 0
                      ? "Free"
                      : `$${(fee.class11to12Science / 1000).toFixed(0)}K`}
                  </span>
                </div>
              </div>
            </div>
